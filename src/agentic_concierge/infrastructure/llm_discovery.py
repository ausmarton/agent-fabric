...
from agentic_concierge.config.constants import LLM_DISCOVERY_TIMEOUT_S, LLM_PULL_TIMEOUT_S
...
def resolve_llm(
    ...
    *,
    ...
    raise RuntimeError(
        ...
        "Set CONCIERGE_CONFIG_PATH to point at a backend that has models."
    )
